...
public:
	...
	{
		/*graph_type g = G;
		NavGraphNode * node1 = g.GetNode(nd1);
		NavGraphNode * node2 = g.GetNode(nd2);

		Vect * pos1 = node1->getPos();
		Vect * pos2 = node2->getPos();
...
inline float Vec2DDistance(const Vect &v1, const Vect &v2)
{
